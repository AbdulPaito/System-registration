    ...
    <div class="page">
        ...
        <form action="" method="post">
            <table>
                ...
                <tr>
                    <td><input type="checkbox" name="employment_status" value="employed" <?= isset($_SESSION['employment_status']) && $_SESSION['employment_status'] == 'employed' ? 'checked' : '' ?>> Employed</td>
                ...
                <tr>
                    <td><input type="checkbox" name="employment_status" value="unemployed" <?= isset($_SESSION['employment_status']) && $_SESSION['employment_status'] == 'unemployed' ? 'checked' : '' ?>> Unemployed</td>
